...
Asistent::Asistent(int a, char* b, char* c, Data d, Data e, float f): Angajat(a, b, c, d, e, f) {}

Asistent::Asistent(const Asistent& temp): Angajat(temp) {}

Asistent& Asistent::operator=(const Asistent& temp) { Angajat::operator=(temp); return *this; }
...
void Asistent::setID(int n)
{
    this->ID = n;
}

Asistent::~Asistent() { delete [] Nume; delete [] Prenume; }
